...
#include "public/utility/MySqlCommandSource.h"
#include "CriticalError.h"

std::string polytour::db::utility::MySqlCommandSource::addObj(const polytour::db::utility::FieldSet &fieldSet,
...
std::string polytour::db::utility::MySqlCommandSource::deleteObj(const polytour::db::utility::FieldSet &fieldSet,
                                                                      repository::Identity repoIdentity) {
    checkFieldSetVsIdentity(fieldSet, repoIdentity);
...
std::string polytour::db::utility::MySqlCommandSource::updateObj(const FieldSet &curFieldSet,
...
std::string polytour::db::utility::MySqlCommandSource::searchObj(
...
std::string
polytour::db::utility::MySqlCommandSource::initTable(const polytour::db::repository::Identity &identity) {
    ...
    for (const auto& column: identity.tableColumns) {
        ...
        switch (column.second.type) {
            ...
            case TableTypes::Serial:
                curColumn += "INT AUTO_INCREMENT PRIMARY KEY"; break;
...
std::string polytour::db::utility::MySqlCommandSource::buildValuesList(const FieldSet& fieldSet,
...
std::string
polytour::db::utility::MySqlCommandSource::buildConditionList(
...
std::string polytour::db::utility::MySqlCommandSource::buildSetList(const FieldSet& fieldSet,
                                                                         const repository::Identity& repoIdentity) {
    std::string setList;
    auto tableColumns = repoIdentity.tableColumns;
...
std::string polytour::db::utility::MySqlCommandSource::valueToSQLCommandView(
...
std::string polytour::db::utility::MySqlCommandSource::buildColumnsList(const repository::Identity& repoIdentity) {
    std::string result = "(";
    for (const auto& column: repoIdentity.tableColumns) {
        if (column.second.type != TableTypes::Serial) {
            result += column.first;
...
void polytour::db::utility::MySqlCommandSource::checkFieldSetVsIdentity(
